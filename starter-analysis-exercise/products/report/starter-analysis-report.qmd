...
Guillermo Gallardo contributed to this exercise. 
...
#| tbl-cap: "Linear model using height as outcome, weekly miles driven and vehicle color as predictors."
#| echo: FALSE
resulttable1=readRDS("../../results/tables-files/resulttable3.rds")
...
@fig-vehicle-color-height shows the boxplots of peoples height grouped by the color of vehicle they drive.

```{r}
#| label: fig-vehicle-color-height
#| fig-cap: "Height by vehicle color."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","Vehicle-Color-Height.png"))
```

@fig-weight-miles shows a scatterplot of a persons weight vs the number of miles they drive weekly. 

```{r}
#| label: fig-weight-miles
#| fig-cap: "Avg Weekly miles drive vs persons weight."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","Weight-Miles.png"))
```
